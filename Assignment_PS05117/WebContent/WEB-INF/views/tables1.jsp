            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <form:form action="tables1.htm" modelAttribute="staff">

							<div style="font-weight: bolder;">ID:</div>
							<form:input path="id" />


							<div class="form-group">
								<label>Name</label>
								<form:input class="form-control" placeholder="Enter text"
									path="name" />
							</div>
							<div class="form-group">
								<label>Gender</label> <label class="radio-inline"> 
								<form:radiobutton path="gender" value="true" label="Male" checked="checked" />
							...
							<hr>
							<div>
								<button name="insert" class="btn btn-default">Insert</button>
                                ...
                                <tbody>
                                 <c:forEach var="s" items="${staffs}">
									<tr>
										...
										<td>${s.notes}</td>
										<td>${s.depart.name}</td>
										<td><a href="tables1.htm?lnkEdit&id=${s.id}"
